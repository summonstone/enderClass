...
<html lang="ko">
  <head>
    ...
    <link rel="stylesheet" href="${path}/css/gallery.css?ver=1" />
  </head>
  <body>
    ...
    <div class="side-bar">
      ...
      <div class="box">
        <h3 class="title">이미지 이름 :</h3>
        <input type="text" placeholder="search image..." id="search-box" />
      </div>
      <div class="box">
        <h3 class="title">세부 목록 :</h3>
        <div class="category">
          <div class="btn active" data-category="all">all</div>
          <div class="btn" data-category="team">team</div>
          <div class="btn" data-category="leisure">leisure</div>
          <div class="btn" data-category="event">event</div>
          <div class="btn" data-category="service">service</div>
        </div>
      </div>
      <div class="box">
    ...
    <div class="gallery">
      <h1 class="heading">추억</h1>

      <div class="image-container">
        <img
          src="${path}/images/img-1.jpg"
          data-cat="team"
          data-search="team member talk 팀 이야기"
          alt=""
        />
        <img
        ...
        />
        <img
          src="${path}/images/img-2.jpg"
          data-cat="leisure"
          data-search="leisure travel 여행 레저 스포츠 캠핑"
          alt=""
        />
        <img
          src="${path}/images/img-3.jpg"
          data-cat="event"
          data-search="event soccer 축구 운동회"
          alt=""
        />
        <img
          src="${path}/images/img-4.jpg"
          data-cat="service"
          data-search="service 봉사 활동 서비스"
          alt=""
        />
        <img
