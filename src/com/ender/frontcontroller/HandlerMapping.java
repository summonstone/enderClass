...
import com.ender.controller.CourseController;
import com.ender.controller.JoinOnlineController;
import com.ender.controller.NoteController;
...
import com.ender.controller.UserClassDetailController;
import com.ender.controller.WatchContactController;
...
import com.ender.controller.UserClassVideo;
...
public class HandlerMapping {
	...
	public HandlerMapping() {
		...
		map.put("/note.do", new NoteController());

		// 연락 페이지
		map.put("/watchContact.do", new WatchContactController());

		// 강의 페이지
		map.put("/joinOnline.do", new JoinOnlineController());
		map.put("/course.do", new CourseController());
		...
		// user전용 페이지
		map.put("/userClassDetail.do", new UserClassDetailController());
		map.put("/userClassVideo.do", new UserClassVideo());
